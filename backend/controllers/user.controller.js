    ...
    try {
        ...
        if(newPassword && currentPassword){
            ...
            if(currentPassword === newPassword){
                return res.status(400).json({error: "New password can't be the old password"});
            }
        ...
        if(profileImg) {
            ...
            const uploaderResponse = await cloudinary.uploader.uploader(profileImg);
        ...
        if(coverImg) {
            ...
            const uploaderResponse = await cloudinary.uploader.uploader(coverImg);
        ...
        //make password to response null
        user.password = null;
